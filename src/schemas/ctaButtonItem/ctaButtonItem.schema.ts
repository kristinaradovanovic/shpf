...
import { CTAButtonItemSchemaType } from './ctaButtonItem.types';

const schemaName = 'ctaButtonItem';
const schemaTitle = 'CTA Button Item';
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      hidden: ({ parent }) => (parent as CTAButtonItemSchemaType)?.ctaType !== 'link',
      validation: (rule) =>
        rule.custom((value, context) => {
          if ((context.parent as CTAButtonItemSchemaType)?.ctaType === 'link' && !value) {
    ...
    defineField({
      ...
      hidden: ({ parent }) => (parent as CTAButtonItemSchemaType)?.ctaType !== 'mail',
      validation: (rule) =>
        rule.custom((value, context) => {
          if ((context.parent as CTAButtonItemSchemaType)?.ctaType === 'mail' && !value) {
    ...
    defineField({
      ...
      hidden: ({ parent }) => (parent as CTAButtonItemSchemaType)?.ctaType !== 'page',
      validation: (rule) =>
        rule.custom((value, context) => {
          if ((context.parent as CTAButtonItemSchemaType)?.ctaType === 'page' && !value) {
    ...
    defineField({
      ...
      hidden: ({ parent }) => (parent as CTAButtonItemSchemaType)?.ctaType !== 'scroll',
      validation: (rule) =>
        rule
          .positive()
          .integer()
          .custom((value, context) => {
            if ((context.parent as CTAButtonItemSchemaType)?.ctaType !== 'scroll') return true;
            if (!value) {
